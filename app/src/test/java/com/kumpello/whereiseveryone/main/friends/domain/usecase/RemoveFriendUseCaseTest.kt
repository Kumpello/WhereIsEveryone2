...
class RemoveFriendUseCaseTest {
    ...
    private val useCase = RemoveFriendUseCase(friendRepository, getCurrentAuthTokenUseCase)
    ...
    fun `execute returns data from repository`() = runTest {
        ...
        coEvery { friendRepository.removeFriend("token", "friend1") } returns expectedResponse
